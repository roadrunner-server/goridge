...
const (
	CONTROL       Flag = 0x01 //nolint:stylecheck,golint
	...
	RESERVED1     Flag = 0x80 //nolint:stylecheck,golint
)

// COMPLEX flags can't be used with Byte flags, because it's value more than 128
const (
	RESERVED2 Flag = 0x81 //nolint:stylecheck,golint
	RESERVED3 Flag = 0x82 //nolint:stylecheck,golint
	RESERVED4 Flag = 0x83 //nolint:stylecheck,golint
	RESERVED5 Flag = 0x84 //nolint:stylecheck,golint
)
