...
Goridge is high-performance golang/php codec library which works over native PHP sockets and Golang net/rpc package. The library allows you to call Go service methods from PHP with minimal footprint, structures and raw data support.
